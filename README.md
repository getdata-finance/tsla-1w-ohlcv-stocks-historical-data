...
- **Free evaluation sample** on GitHub (`1w`) · **11 timeframes** on [getdata.finance](https://getdata.finance/datasets/tsla) · **642** `1w` rows in the full archive
- Built for **backtesting**, **algorithmic trading** and **quantitative finance** workflows
- **Weekly refresh** — [getdata.finance](https://getdata.finance) every **Saturday, 8am UTC+0**; GitHub `1w` sample updated in sync

> **Sample on GitHub** · `TSLA_1w.csv` (106 rows, `2024-09-12` -> `2026-09-17`, 10.49 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/tsla)** — **642** `1w` rows (full `1m`: 615,796), **11 timeframes**, `2011-05-05` -> `2026-09-17`.
...
| 2026-09-17T00:00:00+00:00 | 357.79 | 380.26 | 357.79 | 378.73 | 168491 |
...
The complete **TSLA** archive on **[getdata.finance](https://getdata.finance/datasets/tsla)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **642** rows at `1w`, plus all other timeframes in the same ZIP.
